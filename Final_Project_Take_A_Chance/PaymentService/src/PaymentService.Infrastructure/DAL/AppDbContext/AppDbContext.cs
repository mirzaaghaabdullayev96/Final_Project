...
namespace PaymentService.Infrastructure.DAL.AppDbContext
{
    public class AppDbContext : DbContext
    {
        ...
        public DbSet<AccountTopUp> TransactionAccountTopUps { get; set; }
        public DbSet<BuyTicket> TransactionBuyTickets { get; set; }

        public override async Task<int> SaveChangesAsync(CancellationToken cancellationToken = default)
        {
            var topups = ChangeTracker.Entries<AccountTopUp>();
            var tickets = ChangeTracker.Entries<BuyTicket>();
