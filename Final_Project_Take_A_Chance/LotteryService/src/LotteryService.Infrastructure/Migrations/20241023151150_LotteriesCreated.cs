...
{
    /// <inheritdoc />
    public partial class LotteriesCreated : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllTicketsSoldAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    WinnerChosenAt = table.Column<DateTime>(type: "datetime2", nullable: true),
